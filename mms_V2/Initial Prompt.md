...
- Do not deliver the final paper before G7 (CONTEST_REVIEW_PASSED) — the contest paper review reaches a total score of at least 90. G7 is a mandatory delivery gate that must never be skipped. Below 90, revise per the review findings and re-review.
...
- Rule 4: The paper must pass contest-paper-reviewer with a total score ≥ 90 before delivery. Below 90, revise per the review findings and re-review; no exceptions.
